...
/* snacks_Adaptor snacksAdaptor= new snacks_Adaptor(snacksActivity.this,response.body());
                    ...
                    Toast.makeText(PermitActivity.this, "Unauthorized", Toast.LENGTH_SHORT).show();
                    Log.e("API_ERROR", "Unauthorized: " + response.message());
                } else {
                    Toast.makeText(PermitActivity.this, "Authorized", Toast.LENGTH_SHORT).show();
            ...
            public void onFailure(Call<ArrayList<POJOFandD>> call, Throwable t) {
                Toast.makeText(PermitActivity.this, "check your internet connection ", Toast.LENGTH_SHORT).show();
            }
        });
    }
}*/
