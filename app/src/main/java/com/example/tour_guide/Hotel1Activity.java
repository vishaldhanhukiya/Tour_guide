...
/* snacks_Adaptor snacksAdaptor= new snacks_Adaptor(snacksActivity.this,response.body());
                    ...
                    Toast.makeText(Hotel1Activity.this, "Unauthorized", Toast.LENGTH_SHORT).show();
                    Log.e("API_ERROR", "Unauthorized: " + response.message());
                } else {
                    Toast.makeText(Hotel1Activity.this, "Authorized", Toast.LENGTH_SHORT).show();
            ...
            public void onFailure(Call<ArrayList<POJOFandD>> call, Throwable t) {
                Toast.makeText(Hotel1Activity.this, "check your internet connection ", Toast.LENGTH_SHORT).show();
            }
        });
    }
}*/
