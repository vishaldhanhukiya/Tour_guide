...
public class Hotel_Category_Adaptor extends RecyclerView.Adapter<Hotel_Category_Adaptor.ViewHolder> {
    Context context;
    List<POJOFandD> pojoFandD;

    public Hotel_Category_Adaptor(Context context, ArrayList<POJOFandD> pojoFandD) {
    ...
    @NonNull
    @Override
    public Hotel_Category_Adaptor.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.snackssinglerow, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull Hotel_Category_Adaptor.ViewHolder holder, int position) {
